...
public:
	...
	static void KillProc(std::string name);
	...
	static void DrawBox(int X, int Y, int W, int H, const ImColor color, int thickness);
	static void DrawLine(ImVec2 p1, ImVec2 p2, const ImColor color, int thickness);
